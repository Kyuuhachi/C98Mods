...
public class FramedataImpl1 implements FrameBuilder {
	...
	@Override public boolean getTransfereMasked() {
	...
	@Override public void setFin(boolean fin) {
		this.fin = fin;
	}
	
	@Override public void setOptcode(Opcode optcode) {
	...
	@Override public void setTransferemasked(boolean transferemasked) {
		this.transferemasked = transferemasked;
	}
	
	@Override public void append(Framedata nextframe) throws InvalidFrameException {
