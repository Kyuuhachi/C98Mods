...
public class ContainerMagicFurnace extends Container {
	...
	@Override public void onCraftGuiOpened(ICrafting client) {
		super.onCraftGuiOpened(client);
		client.func_175173_a(this, inventory);
	}
	...
	@Override public void detectAndSendChanges() {
		...
		for(int i = 0; i < crafters.size(); ++i) {
			ICrafting client = (ICrafting)crafters.get(i);
			
			if(prevTime != inventory.getField(FIELD_TIME)) client.sendProgressBarUpdate(this, FIELD_TIME, inventory.getField(FIELD_TIME));
			if(prevTotalTime != inventory.getField(FIELD_TOTAL_TIME)) client.sendProgressBarUpdate(this, FIELD_TOTAL_TIME, inventory.getField(FIELD_TOTAL_TIME));
		}
