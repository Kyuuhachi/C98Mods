...
public class GLImpl {
	...
	private void store() { //TODO this should be cleaned up.
		...
		stencil_func_func = stencilState.func.func;
		stencil_func_mask = stencilState.func.mask;
		stencil_mask = stencilState.mask;
		stencil_fail = stencilState.fail;
		stencil_zfail = stencilState.zfail;
		stencil_zpass = stencilState.zpass;
	...
	private void load() {
		...
		stencilState.func.func = stencil_func_func;
		stencilState.func.mask = stencil_func_mask;
		stencilState.mask = stencil_mask;
		stencilState.fail = stencil_fail;
		stencilState.zfail = stencil_zfail;
		stencilState.zpass = stencil_zpass;
